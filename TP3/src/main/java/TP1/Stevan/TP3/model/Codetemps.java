...
public enum Codetemps {
    ...
    Codetemps(int code, String description) {
        this.code = code;
        this.description = description;
    }
    
    public static String getDescriptionByCode(int code) {
        for (Codetemps codeMeteo : Codetemps.values()) {
            if (codeMeteo.getCode() == code) {
                return codeMeteo.getDescription();
            }
        }
        return "Code météo non trouvé";
    }
